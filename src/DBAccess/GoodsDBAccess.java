...
public class GoodsDBAccess extends DBAccess{
    ...
    public ArrayList<Goods> getGods() throws SQLException{
    ...
    public void editGoods(Goods goods) throws SQLException{
            Connection connection = getConnect();
            PreparedStatement prep = connection.prepareStatement(""
    ...
    public int delGoods(Goods goods) throws SQLException{
        try {
            Connection connection = getConnect();
            PreparedStatement prep = connection.prepareStatement(""
